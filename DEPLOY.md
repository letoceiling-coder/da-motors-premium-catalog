...
## ✅ РЕКОМЕНДУЕТСЯ: Использование безопасного скрипта

**Этот скрипт СТРОГО защищает данные от удаления!**
...
**Что делает скрипт:**
- ✅ Создает **двойной бэкап** данных (в `/tmp` и `/home/dsc23ytp`)
- ✅ **НИКОГДА** не удаляет `public/data/`
- ✅ Восстанавливает данные после клонирования
- ✅ Проверяет наличие данных в конце деплоя
- ✅ Выполняет экстренное восстановление, если данные потеряны
